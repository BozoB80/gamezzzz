...
export function ThemeToggle() {
  ...
  return (
    ...
    <div className="relative flex justify-center items-center">
      ...
      <SunIcon className="absolute right-1 z-10 h-[1rem] w-[1rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 text-yellow-400 fill-yellow-400" style={{ pointerEvents: "none" }} />
    </div>
  )
}