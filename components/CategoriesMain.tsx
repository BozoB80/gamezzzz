...
const CategoriesMain = ({ categories }: CategoriesMainProps) => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-6 grid grid-cols-12 gap-6">
      {categories.slice(0, 4).map((category) => (
        <Card radius="sm" isPressable onPress={() => router.push(`/categories/${category.id}`)} key={category.id} className="col-span-12 sm:col-span-3 aspect-[3/4] rounded-lg">
